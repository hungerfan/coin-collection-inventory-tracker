...
if __name__ == "__main__":
    # Test examples
    ms65 = Condition(id=1, name="MS-65",
                     description="Mint State 65 - Choice Brilliant Uncirculated")

    au58 = Condition(id=2, name="AU-58",
                     description="About Uncirculated 58 - Trace of wear")

    vf20 = Condition(id=3, name="VF-20",
                     description="Very Fine 20 - Well worn")
