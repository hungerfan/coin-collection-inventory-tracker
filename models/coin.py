...
class Coin(BaseModel):  # pylint: disable=too-many-instance-attributes
    ...
    def __str__(self):
        ...
        return f"ID: {self.id} - Type ID: {self.type_id} - Year: {self.year} - "\
    ...
    def __repr__(self):
        ...
        return f"Coin(id={self.id}, type_id={self.type_id}, year={self.year}, "\
...
if __name__ == "__main__":
    coin = Coin(id=1, type_id=1, year=1900, mint_mark="D", condition_id="VF-20",
                quantity=1, value_estimate=45.00, acquired_from="Bar", notes="Test Coin")
