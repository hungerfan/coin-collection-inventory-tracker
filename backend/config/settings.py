"""
Django settings for coin collection tracker backend.
"""
...
# Load environment variables from root .env file (shared with CLI app)
root_env = BASE_DIR.parent / '.env'
if root_env.exists():
    load_dotenv(root_env)

# Also load backend-specific .env if it exists (for Django-only settings)
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'coin_tracker'),
